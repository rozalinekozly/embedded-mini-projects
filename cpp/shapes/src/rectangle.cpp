...
Rectangle::Rectangle(const ilrd::Point& center,
...
Rectangle& Rectangle:: Draw() const
{
    int x = (int)(this->GetPoint().GetX());
    int y = (int)(this->GetPoint().GetY());
    int distUp = (int)(this->GetHeight()/2);
    int distDown =  (int)(this->GetWidth()/2);

    //set vertices x and y
    int x_vertices[2] = {x + distUp, x - distUp};
    int y_vertices[2] = {y + distDown, y - distDown};
